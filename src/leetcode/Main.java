...
import leetcode.arraysminheap.LC347_TopKFreqElement;
import leetcode.arraysorting.LC912_SortAnArray;
import leetcode.hashing.LC36_ValidSudoku;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// LC347
		System.out.println(Arrays.toString(LC347_TopKFreqElement.solve(new int[] { 1, 1, 1, 2, 2, 3 }, 2)));
		...
		System.out.println(LC36_ValidSudoku.solve(board));
